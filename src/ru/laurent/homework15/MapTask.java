...
public class MapTask {
    ...
    public static void main(String[] args) {
        ...
        String city = "Тверь";
        public static void ReturnLogin(firstTaskMap<String, String>, city) {
            // сделать как на лекции пары ключ значение (поиск по по значению)
            ReturnLogin.value()
            return list1;
